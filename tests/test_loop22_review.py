...
class LoopTwentyTwoTests(unittest.TestCase):
    ...
    def test_to_the_recipient_is_not_a_new_speaker(self):
        ...
        ms=load_mention_reviews(self.raw);self.assertEqual(len(ms),22)
        self.assertEqual({e['ID_Padre'] for e in ms.values() if e['Decision']=='PENDIENTE_DELIMITAR_APORTE'},{6185})
