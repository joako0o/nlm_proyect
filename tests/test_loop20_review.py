...
class LoopTwentyTests(unittest.TestCase):
    ...
    def test_eight_readings_leave_alerts_and_source_rows_untouched(self):
        ...
        self.assertEqual(sum(e['Decision']==DECISION for e in self.mentions.values()),25)
        self.assertEqual([e['ID_Padre'] for e in self.mentions.values() if e['Decision']==PENDING_DECISION],[6185,3775,4055])
