"""QA de preparación para v11: el mismo módulo, con la comparación interna apuntando a v11.
...
porque eso es lo que v7 debía probar. v11 agrega una fila legítimamente, así que
esa comparación interna se sustituye en memoria por la de v11.
...
import compare_procedural_v11 as v11  # noqa: E402
import qa_preparacion  # noqa: E402


def compare_como_v11(antes, despues, refinamientos):
    """Reemplaza la comparación v7 por la v11 dentro de qa_preparacion.
    ...
    candidato = stage / v11.BASE.name
    report, _ = v11.compare(v11.read_rows(v11.BASE), v11.read_rows(candidato), v11.revisiones())
    if not report['Pasa']:
        raise ValueError('La comparación v11 no pasó')
    return report, []
