"""QA de preparación para v10: el mismo módulo, con la comparación interna apuntando a v10.
...
porque eso es lo que v7 debía probar. v10 agrega una fila legítimamente, así que
esa comparación interna se sustituye en memoria por la de v10.
...
import compare_procedural_v10 as v10  # noqa: E402
import qa_preparacion  # noqa: E402


def compare_como_v10(antes, despues, refinamientos):
    """Reemplaza la comparación v7 por la v10 dentro de qa_preparacion.
    ...
    candidato = stage / v10.BASE.name
    report, _ = v10.compare(v10.read_rows(v10.BASE), v10.read_rows(candidato), v10.revisiones())
    if not report['Pasa']:
        raise ValueError('La comparación v10 no pasó')
    return report, []
