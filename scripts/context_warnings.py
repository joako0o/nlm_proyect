...
DECISIONS={NAME_MOTIVE:'PENDIENTE_CONTRASTE_NOMBRE', DAMAGE_MOTIVE:'PENDIENTE_COTEJO_TEXTUAL', JOINT_MOTIVE:'PENDIENTE_DELIMITACION_CONJUNTA', MOTIVE:'PENDIENTE_CONTRASTE_CARGO',
